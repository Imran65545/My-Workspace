...
export default function LoginPage() {
  ...
  return (
    <form onSubmit={handleLogin} className="max-w-md mx-auto px-4 sm:px-0 mt-16 sm:mt-20 space-y-4">
      <ToastContainer />
      <h1 className="text-2xl font-bold text-center sm:text-left">Login</h1>
      <input
        placeholder="Email"
        value={email}
        onChange={(e) => setEmail(e.target.value)}
        className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-400"
      />
      <input
        ...
        className="w-full p-3 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-400"
      />
      <button className="w-full sm:w-auto bg-blue-600 text-white px-5 py-2.5 rounded-md hover:bg-blue-700 transition">
        Login
      </button>
      ...
      <button
        ...
        className="w-full flex items-center justify-center gap-2 bg-white border border-gray-300 text-gray-700 px-4 py-2 rounded-md hover:bg-gray-100 transition"
      >
